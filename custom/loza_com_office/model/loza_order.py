...
class loza_order(models.Model):
    ...
    originating_office = fields.Many2one('loza.office', string='Originating Office',related="order_user.office_id",store=True,index=True)
    ...
    def get_response_count(self):
        count = self.env['loza.order.response'].search_count([('order_id', '=', self.id),('office_id','in',self._get_total_offices())])
