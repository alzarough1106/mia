...
class loza_order(models.Model):
    ...
    #     count = self.env['loza.make.order.appointment'].search_count([('ambulance_id', '=', self.id)])
...
#     loza_prescription_order_ids = fields.One2many('loza.prescription.order', 'appointment_id', string='Prescription')
...
#     transfer = fields.Many2one('loza.clinic.transfer', string="Transfer Note")
    ...
    #     }
    #
    # def open_radiology_orders(self):
    #     return {
    ...
    #         'view_mode': 'tree,form',
    #         'res_model': 'loza.prescription.order.quick',
    #         'type': 'ir.actions.act_window',
    #     }
    #
    ...
    #     count = self.env['loza.prescription.order.quick'].search_count(
    ...
    #     # Orders
    #     list = self.env['loza.make.order.appointment'].search(
    #         [('ambulance_id', '=', self.id), ('state', '=', 'submitted')])
    #     for order in list:
    #         if not order.is_invoiced:
    #             order.action_create_order_invoice(True)
    #         else:
    #             # it has been invoiced but not paid
    ...
    #     appointment_listings = self.env['loza.make.order.appointment'].search([('ambulance_id', '=', self.id)])
    #
    ...
    #             raise UserError("There is an Order which has not been Paid/Closed")
    #
    #
    ...
    #             return result
    #
    # def loza_patient_order_history(self):
    #     return {
    #         'name': _('Order History'),
    #         'domain': [('ambulance_id', '=', self.id)],
    #         'view_mode': 'tree,form',
    #         'res_model': 'loza.make.order.appointment',
    #         'type': 'ir.actions.act_window',
    #         'context': dict(
    #             self.env.context,
    ...
    #     }
    #
    # def make_order_radiology_ambulance(self):
    #     return {
